...
bothSidedMods = ['accurate-block-placement', 'addadd', 'additionz', 'advancement-frames', 'air-hop', 'another-furniture', 'antighost', 'appleskin', 'aquatic-torches', 'architectury-api', 'armor-statues', 'auditory', 'autotag', 'axes-are-weapons', 'axolotl-bucket-fix', 'balm', 'beautified-chat-client', 'beautify-refabricated', 'bedspreads', 'beenfo', 'beneath-the-snow', 'better-biome-blend', 'better-stats', 'better-third-person', 'better-tridents', 'bits-and-chisels', 'cake-chomps', 'cammies-minecart-tweaks', 'capybara-fabric', 'cc-restitched', 'celestria', 'chefs-delight', 'chimes', 'chunky', 'cleancut', 'clickthrough', 'cloth-api', 'cloth-config', 'clumps', 'collective', 'colorfulanvils', 'comforts', 'completeconfig', 'compostable-rotten-flesh', 'connectible_chains', 'controlling', 'couplings', 'crafting-tweaks', 'create-fabric', 'ct-overhaul-village', 'cyanide-fabric', 'deathlog', 'debugify', 
'deepslatecutting','slice-and-dice', 'create-steam-n-rails', 'polymorph','diagonal-fences', 'diagonal-panes', 'displaycase', 'do-a-barrel-roll', 'easy-anvils', 'easy-magic', 'easy-shulker-boxes', 'editsign', 'effective', 'enchanted-vertical-slabs', 'expanded-delight', 'expanded-trident-enchanting', 'fabric-disable-custom-worlds-advice', 'fabric-seasons-delight-compat', 'fabric-seasons-extras', 'fabric-seasons', 'farmers-delight-fabric', 'farmers-knives', 'farmers-respite-fabric', 'fast-furnace-for-fabric', 'ferrite-core', 'fish-on-the-line', 'forge-config-api-port', 'fwaystones', 'gliders', 'handcrafted', 'herdspanic', 'horse-expert', 'horsebuff', 'iceberg', 'illuminations', 'immersive-paintings', 'immersive-weathering', 
...
'moonlight', 'more-banner-features', 'more-mob-variants', 'more-villagers-fabric', 'mru', 'natures-compass', 'nicephore-fabric', 'no-chat-reports', 'no-strip', 'nullscape', 'owo-lib', 'patchouli', 'paxi', 'pick-up-notifier', 'playeranimator', 'pling', 'prism-lib', 'projectsavethepets', 'puzzles-lib', 'pyrotastic', 'qkl', 'qsl', 'quit', 'recipe-cache', 'rei', 'replanter', 'resourceful-lib', 'searchables', 'shiny-horses', 'show-me-what-you-got', 'show-me-your-skin', 'simple-voice-chat', 'smoothboot-fabric', 'soul-fire-d', 'spark', 'starlight', 'supplementaries', 'talkbubbles', 'terralith', 'things', 'thorium', 'torch-hit', 'trinkets', 'universal-enchants', 'universal-graves', 'variant-bookshelves-fabric', 'visual-overhaul', 'visual-workbench', 'voidtotem', 'xaeros-minimap', 'xaeros-world-map', 'way2wayfabric', 'yacl', 'yosbr', 'yungs-api']
clientSidedMods = ['advancementinfo',
'axolotl-buckets', 'borderless-mining', 'better-mount-hud', 'better-ping-display-fabric', 'betterf3', 'chat-heads', 'colormatic', 'craftify', 'craftpresence', 
